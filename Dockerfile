...
#
#   * pull in all the dependencies needed for OpenCV 4.4 including python 2 dependencies
#   * pull in OpenCV 4.4 and opencv_contrib and build them
#       + executable files end up in opencv-4.4.0/build/bin
...
# Second: get and build OpenCV 4.4
#
RUN cd \
...
#    I copy the needed data to where the executables will be: opencv-4.4.0/build/bin
#
RUN cd \
